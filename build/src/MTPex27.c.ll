; ModuleID = 'MTPex27.c.ll'
source_filename = "MTPex27.c"
...
bb:
  ...
  store i32* %i, i32** @v, align 8
  %i1 = load i32*, i32** @v, align 8
  store i32* %i1, i32** @u, align 8
  %i2 = load i32*, i32** @u, align 8
  store i32* %i2, i32** @x, align 8
  ret i32 0
}
...
bb:
  store i32* @d, i32** @u, align 8
  store i32* @c, i32** @v, align 8
  %i1 = call i32 @p()
