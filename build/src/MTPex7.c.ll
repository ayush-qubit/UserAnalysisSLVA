; ModuleID = 'MTPex7.c.ll'
source_filename = "MTPex7.c"
...
bb:
  ...
  %i1 = load i32*, i32** @g, align 8
  %i2 = load i32, i32* %i1, align 4
  %i3 = icmp sgt i32 %i2, 1
  br i1 %i3, label %bb4, label %bb7

bb4:                                              ; preds = %bb
  %i5 = load i32*, i32** @e, align 8
  store i32* %i5, i32** @f, align 8
  %i6 = load i32, i32* @c, align 4
  call void @fun3(i32 %i6)
  br label %bb9

bb7:                                              ; preds = %bb
  %i8 = load i32*, i32** @g, align 8
  store i32* %i8, i32** @f, align 8
  br label %bb9
